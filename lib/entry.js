...
import bigGrep from './commands/bigGrep'
...
export default ({ subscriptions, fileIconsService }) => {
	...
	let serviceWorkerResolve

	window.filterServiceWorker = new Promise(resolve => {
		serviceWorkerResolve = resolve
	})

	navigator.serviceWorker
		.register('/Users/gerardmtb/dev/sparkling/worker/index.js')
		.then(onRegistration)
