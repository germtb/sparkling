...
import commandFactoryFactory from './commands/commandFactory'
...
module.exports = {
	...
	bootstrap() {
		...
		const dependencies = { store, commandFactory: this.commandFactory }
		...
		const lsShowCommand = this.commandFactory(lsShow)
		const lsShowUpCommand = this.commandFactory(lsShowUp)
