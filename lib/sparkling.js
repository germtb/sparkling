...
module.exports = {
	...
	bootstrap() {
		const dependencies: Dependencies = dependenciesFactory()

		const { store, fromAction, commandFactory } = dependencies

		this.commandFactory = commandFactory

		this.rxSubscription = fromAction('HIDE').subscribe(() => {
		...
		const add = (name, commandFactoryOptions: Dependencies => Options) => {
