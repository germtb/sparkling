...
const allLinesFactory = (React, store) => {
	...
	return { loadData, accept, type: 'allLines' }
}

const autocompleteLinesFactory = (React, store) => {
	const accept = line => {
		store.dispatch({ type: 'HIDE' })
	...
	return { loadData, accept, renderer, type: 'autocompleteLines' }
}

module.exports = { allLinesFactory, autocompleteLinesFactory }
