...
import loadDataFactory from './dataSources/bigGrep'
...
export default dependencies => {
	...
	const FindContainer = compose(
		...
		withSideEffect(fromSelector(getFind).debounceTime(100))(find => {
	...
	return {
		...
		childrenRenderer: () => <FindContainer />
	}
}
