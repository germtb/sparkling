...
import type { State, Item, Options, ItemArray } from './types'

export const isVisible = (state: State): boolean => state.visible
export const getOptions = (state: State): Options => state.options
export const getData = (state: State): ItemArray => state.data
...
export const getSparklingData = (state: State): ItemArray => state.sparklingData
...
export const getExtraInput = (state: State): { id?: string, [string]: any } =>
	state.extraInput
...
export const getMultiselected = (state: State): ItemArray => state.multiselected
