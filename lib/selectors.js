...
export const getPattern = (state: State): number => state.pattern.value
export const getSelectedValue = (state: State): number =>
...
export const getExtraInput = (state: State): { value: string, id: string } =>
	state.extraInput
