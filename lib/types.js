...
export type AppendFilteredDataActionType = 'APPEND_FILTERED_DATA'
...
export type SetFilteredDataAction = {|
	+type: AppendFilteredDataActionType,
	+payload: { data: ItemArray }
|}
...
export type Options = LsOptions | FileOptions | NullOptions
...
export type FileOptions = {
	...$Exact<BaseOptions<SimpleItem>>,
	+id: 'sparkling-files',
	+multiselect: true,
	+accept: (Array<SimpleItem>) => void
}
